...
//   const [boardDetails, setBoardDetails] = useState(null); // Add state for board details

//   console.log("boardDetails:", boardDetails);
//   // Fetch board details when Configuration tab is active
//   useEffect(() => {
//     if (activeTab === "configuration" && !isEditing) {
//       GetBoardDetails();
//     }
//   }, [activeTab, isEditing]); // Run when activeTab or isEditing changes

//   const GetBoardDetails = async () => {
//     try {
//       // Call the API to get all boards
...
//       // Store the board details in state
//       setBoardDetails(response); // Adjust according to your API response structure
//     } catch (error) {
//       console.error("Failed to fetch board details:", error);

//       // Show detailed error message to user
//       let errorMessage = "❌ Failed to fetch board details. Please try again.";
...
//     setIsEditing(false);
//     // Optionally refresh the board details after saving
//     GetBoardDetails();
//   };
...
//             boardDetails={boardDetails} // Pass board details to ConfigurationDetails
//           />
//         ) : (
//           <Configuration
//             onEdit={handleEditDetails}
//             boardDetails={boardDetails} // Pass board details to Configuration
//           />
//         )}
//       </div>
//     </div>
